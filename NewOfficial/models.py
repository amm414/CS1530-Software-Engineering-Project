...
def initdb_command():
	...
	db.session.add(User(username='jmd230', email="jmd230@pitt.edu", password='pass', phonenumber='4121234567', personalemail='jordanmdeller@gmail.com', bio='Serious offers only'))
